...
import { ResourceErrorCode } from './error-codes.js';
...
export class ResourceError {
    ...
    static invalidUriFormat(uri: string, expected?: string) {
        return new DextoRuntimeError(
            ResourceErrorCode.INVALID_URI_FORMAT,
            ErrorScope.RESOURCE,
            ErrorType.USER,
    ...
    static providerNotInitialized(providerType: string, uri: string) {
        return new DextoRuntimeError(
            ResourceErrorCode.PROVIDER_NOT_INITIALIZED,
            ErrorScope.RESOURCE,
            ErrorType.SYSTEM,
    ...
    static providerNotAvailable(providerType: string) {
        return new DextoRuntimeError(
            ResourceErrorCode.PROVIDER_NOT_AVAILABLE,
            ErrorScope.RESOURCE,
            ErrorType.SYSTEM,
    ...
    static accessDenied(uri: string) {
        return new DextoRuntimeError(
            ResourceErrorCode.ACCESS_DENIED,
            ErrorScope.RESOURCE,
            ErrorType.FORBIDDEN,
    ...
    static noSuitableProvider(uri: string) {
        return new DextoRuntimeError(
            ResourceErrorCode.NO_SUITABLE_PROVIDER,
            ErrorScope.RESOURCE,
            ErrorType.NOT_FOUND,
    ...
    static providerError(providerType: string, operation: string, reason: string) {
        return new DextoRuntimeError(
            ResourceErrorCode.PROVIDER_ERROR,
            ErrorScope.RESOURCE,
            ErrorType.SYSTEM,
