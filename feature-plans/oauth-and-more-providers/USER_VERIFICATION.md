...
| UV-4 | Provider identity: models.dev IDs are canonical; deprecate Dexto-local IDs | 2026-02-18 | Align user-facing IDs to models.dev; generate `LLMProvider` from models.dev provider snapshot (plus small Dexto-only overlay). No alias/back-compat required. |
