...
- `dexto init`: Initialize the current folder as a Dexto workspace (`AGENTS.md`, `agents/`, `.agents/skills/`) and seed `.agents/skills/create-skill/` as a starter skill bundle.
...
- `dexto init skill <id>`: Create `.agents/skills/<id>/SKILL.md` plus `handlers/`, `scripts/`, `mcps/`, and `references/`.
