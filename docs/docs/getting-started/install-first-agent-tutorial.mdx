...
This opens the Web UI with your new default agent. Ask it "Who are you?", and you will see that instead of the `default-agent`, dexto is now using the `music-agent`!
