...
- `agents/`
- `.agents/skills/`
- `.agents/skills/create-skill/` as a starter skill bundle for authoring more skills
...
- `dexto init skill <id>` creates `.agents/skills/<id>/SKILL.md` plus `handlers/`, `scripts/`, `mcps/`, and `references/`
