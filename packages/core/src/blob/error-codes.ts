...
export enum BlobErrorCode {
    ...
    BLOB_INVALID_BACKEND_TYPE = 'BLOB_INVALID_BACKEND_TYPE',
    BLOB_BACKEND_CONFIG_MISSING = 'BLOB_BACKEND_CONFIG_MISSING',

    // Storage errors
    BLOB_SIZE_EXCEEDED = 'BLOB_SIZE_EXCEEDED',
    BLOB_TOTAL_SIZE_EXCEEDED = 'BLOB_TOTAL_SIZE_EXCEEDED',
    BLOB_STORAGE_FULL = 'BLOB_STORAGE_FULL',
    ...
    BLOB_BACKEND_TIMEOUT = 'BLOB_BACKEND_TIMEOUT',
    BLOB_BACKEND_CREDENTIALS_INVALID = 'BLOB_BACKEND_CREDENTIALS_INVALID',

    // Operation errors
    BLOB_CLEANUP_FAILED = 'BLOB_CLEANUP_FAILED',
    BLOB_MIGRATION_FAILED = 'BLOB_MIGRATION_FAILED',
