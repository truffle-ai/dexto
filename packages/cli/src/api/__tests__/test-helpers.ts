...
import type { DextoApp } from '@dexto/server';
...
/**
 * Helper to get the request handler for testing
 * Note: Hono uses fetch API, so tests may need to use fetch-based testing instead of supertest
 */
export function getRequestHandler(testServer: TestServer): DextoApp {
