        ...
        <header className="shrink-0 border-b border-border/50 bg-background/95 backdrop-blur-xl shadow-sm">
          <div className="flex justify-between items-center px-4 py-3">
            <div className="flex items-center space-x-4">
              ...
              >
                <img src="/logos/dexto_logo_light_thicker.svg" alt="Dexto" className="h-12 w-auto dark:hidden" />
                <img src="/logos/dexto_logo_thicker.svg" alt="Dexto" className="h-12 w-auto hidden dark:block" />
                ...
                <div className="w-full max-w-[var(--thread-max-width)] mx-auto space-y-6">
                  <div className="text-center space-y-3">
                    <div className="flex items-center justify-center gap-3">
                      <img src="/logos/dexto_logo_icon_thicker.svg" alt="Dexto" className="h-12 w-auto" />
