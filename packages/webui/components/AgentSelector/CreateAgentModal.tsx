        ...
        if (systemPrompt && typeof systemPrompt === 'object' && 'contributors' in systemPrompt) {
            ...
            if (Array.isArray(contributors)) {
                const hasContent = contributors.some((c: Record<string, unknown>) => {
                    if (c.type === 'static' && typeof c.content === 'string' && c.content.trim())
                        return true;
                    return false;
                });
                if (!hasContent) {
                    newErrors.systemPrompt =
                        'At least one static contributor with content is required';
                }
            }
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        <br />
                        <br />
                        You can add more advanced configuration after creating the agent using the
                        Edit Agent button.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    >
                        <div className="space-y-4">
                            <div>
                                <LabelWithTooltip
                                    htmlFor="agent-id"
                                    tooltip="Unique identifier for this agent (lowercase, no spaces, hyphens only)"
                                >
                                    Agent ID *
                                </LabelWithTooltip>
                                <Input
                            ...
                            <div>
                                <LabelWithTooltip
                                    htmlFor="agent-name"
                                    tooltip="Display name for this agent (shown in UI)"
                                >
                                    Agent Name *
                                </LabelWithTooltip>
                                <Input
                            ...
                            <div>
                                <LabelWithTooltip
                                    ...
                                    tooltip="Your name or organization"
                                >
                                    Author
                                </LabelWithTooltip>
                                <Input
                            ...
                            <div>
                                <LabelWithTooltip
                                    htmlFor="agent-tags"
                                    tooltip="Comma-separated tags for categorization"
                                >
                                    Tags
                                </LabelWithTooltip>
                                <Input
