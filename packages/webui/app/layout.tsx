...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    icon: [
      { url: "/logos/dexto_2/dexto_logo_icon.svg", type: "image/svg+xml" }
    ],
    shortcut: [{ url: "/logos/dexto_2/dexto_logo_icon.svg", type: "image/svg+xml" }],
    apple: [{ url: "/logos/dexto_2/dexto_logo_icon.svg", type: "image/svg+xml" }],
  },
  openGraph: {
    title: "Dexto",
    description:
